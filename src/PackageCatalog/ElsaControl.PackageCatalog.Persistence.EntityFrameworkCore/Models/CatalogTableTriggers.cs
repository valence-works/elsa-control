...
internal static class CatalogTableTriggers
{
    private static readonly IReadOnlyDictionary<string, string[]> SqlServer = new Dictionary<string, string[]>(StringComparer.Ordinal)
    {
        ...
        ["ElsaInstanceProvisioningContexts"] = ["TR_ElsaInstanceProvisioningContexts_AppendOnly"],
        ...
        ["ExternalEngineEnrollmentAuditEvents"] = ["TR_ExternalEngineEnrollmentAuditEvents_AppendOnly"],
        ["ExternalEngineConnectionAuditEvents"] = ["TR_ExternalEngineConnectionAuditEvents_AppendOnly"],
    ...
    private static readonly IReadOnlyDictionary<string, string[]> Sqlite = new Dictionary<string, string[]>(StringComparer.Ordinal)
    {
        ...
        ["ElsaInstanceProvisioningContexts"] = ["TR_ElsaInstanceProvisioningContexts_AppendOnly_Delete", "TR_ElsaInstanceProvisioningContexts_AppendOnly_Update"],
        ...
        ["ElsaInstances"] = ["TR_ElsaInstances_NoDelete"],
        ["ExternalEngineEnrollmentAuditEvents"] = ["TR_ExternalEngineEnrollmentAuditEvents_AppendOnly_Delete", "TR_ExternalEngineEnrollmentAuditEvents_AppendOnly_Update"],
        ["ExternalEngineConnectionAuditEvents"] = ["TR_ExternalEngineConnectionAuditEvents_AppendOnly_Delete", "TR_ExternalEngineConnectionAuditEvents_AppendOnly_Update"],
