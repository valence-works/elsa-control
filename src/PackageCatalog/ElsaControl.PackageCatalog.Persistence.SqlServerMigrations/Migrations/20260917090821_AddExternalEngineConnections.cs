...
namespace ElsaControl.PackageCatalog.Persistence.SqlServerMigrations.Migrations
{
    ...
    public partial class AddExternalEngineConnections : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnershipMode = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    RuntimeHealth = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    ConnectorReachability = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    LastAuthenticatedAt = table.Column<long>(type: "bigint", nullable: true),
                    ConnectorProtocol = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ConnectorVersion = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    ObservedDistribution = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ObservedVersion = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ReleaseEvidenceLevel = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    StudioDestination = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    CapabilitiesObservedAt = table.Column<long>(type: "bigint", nullable: true),
                    ActiveIdentityId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastChallengeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IdempotencyKey = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    CreateRequestDigest = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.Sql("""
                EXEC(N'CREATE TRIGGER TR_ExternalEngineConnectionAuditEvents_AppendOnly
                ON ExternalEngineConnectionAuditEvents
                INSTEAD OF UPDATE, DELETE
                AS BEGIN
                    THROW 51021, ''External engine connection audit events are append-only'', 1;
                END;');
                """);
        }
        ...
        {
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS TR_ExternalEngineConnectionAuditEvents_AppendOnly;");
